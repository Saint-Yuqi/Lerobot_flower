...
class ActionIndex:
    ...
    def __init__(self):
        ...
        self.action_spaces = {
            ...
            'so101': 3,        # SO-101 6-DoF follower (type 3) — vendored patch F4
            # 'nav': 4,         # Navigation (was type 3, bumped)
        }
        ...
        self.action_dims = {
            ...
            'so101': 6,        # SO-101 6-DoF (type 3) — vendored patch F4
            # 'nav': 2,         # Navigation
        }
        ...
        self.action_space_mapping = {
            ...
            ('SO101', 'position', 1): 3,  # SO-101 6-DoF position control — vendored patch F4
            # ('NAV', 'position', 1): 4,  # navigation
        }
        ...
        self.dataset_configs = {
            ...
            "so101": ('SO101', 'position', 1),  # vendored patch F4
