...
from lerobot_hw.utils.errors import DeviceNotConnectedError
...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from lerobot_hw.cameras.opencv import OpenCVCamera
        from lerobot_hw.cameras.configuration_opencv import OpenCVCameraConfig
